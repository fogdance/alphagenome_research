...
生成时间: 2026-03-03 11:08:55

## Checkpoint Info

- Source: checkpoint
- Checkpoint step: 3
- Checkpoint dir: `/home/v/Documents/work/1_open_source/alphagenome_research/checkpoints/m5/baseline_seed43/best`
- Train run ID: e2eb17a4
- Git SHA: ec2d865
- Split: val
...
python src/alphatrade/scripts/eval_m4_fast.py \
  --train-metrics reports/m5_baseline_seed43_train_metrics.json \
  --ckpt-step best \
  --split val \
  --smoke
```
