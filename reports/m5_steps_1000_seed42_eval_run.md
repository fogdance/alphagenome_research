...
生成时间: 2026-03-03 13:43:04

## Checkpoint Info

- Source: checkpoint
- Checkpoint step: 3
- Checkpoint dir: `/home/v/Documents/work/1_open_source/alphagenome_research/checkpoints/m5/steps_1000_seed42/best`
- Train run ID: 83d1f207
- Git SHA: acd0e21
- Split: val
...
python src/alphatrade/scripts/eval_m4_fast.py \
  --train-metrics reports/m5_steps_1000_seed42_train_metrics.json \
  --ckpt-step best \
  --split val \
  --smoke
```
