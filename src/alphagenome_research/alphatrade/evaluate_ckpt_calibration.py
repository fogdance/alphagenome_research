...
Usage:
  python src/alphagenome_research/alphatrade/evaluate_ckpt_calibration.py \
    --ckpt src/alphagenome_research/alphatrade/runs/jm_v03/best.pkl \
    --val_npz src/alphagenome_research/alphatrade/alphatrade_ds_jm/val.npz
"""
