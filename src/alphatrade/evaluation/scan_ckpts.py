...
def main():
    ...
    ap.add_argument(
        "--eval_py",
        default="src/alphatrade/evaluate_ckpt_calibration.py",
    )
...
# # 扫 val
# python src/alphatrade/scan_ckpts.py \
#   --run_dir src/alphatrade/runs/jm_v03 \
#   --npz src/alphatrade/alphatrade_ds_jm/val.npz \
#   --batch 64
#
# # 扫 train（用于判断过拟合）
# python src/alphatrade/scan_ckpts.py \
#   --run_dir src/alphatrade/runs/jm_v03 \
#   --npz src/alphatrade/alphatrade_ds_jm/train.npz \
#   --batch 64
